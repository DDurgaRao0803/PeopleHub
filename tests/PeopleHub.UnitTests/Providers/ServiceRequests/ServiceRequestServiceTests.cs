...
request.AssignProvider(Guid.NewGuid());
    ...
    result.Status.Should().Be(ServiceRequestStatus.Accepted.ToString());
...
request.AssignProvider(Guid.NewGuid());
    ...
    result.Status.Should().Be(ServiceRequestStatus.Rejected.ToString());
...
request.AssignProvider(Guid.NewGuid());
    ...
    result.Status.Should().Be(ServiceRequestStatus.Cancelled.ToString());
...
request.AssignProvider(Guid.NewGuid());
    ...
    result.Status.Should().Be(ServiceRequestStatus.Completed.ToString());
